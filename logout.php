...
<body>
    ...
    <nav class="navbar navbar-expand-md bg-white navbar-light">
        <div class="container">
            <!-- logo  -->
            <a class="navbar-brand" href="logout.php" style="color: #black;"><b>Amour</b>.vn</a>
                ...
                <div class="row">
                    ...
                    <?php
                        while ($row = mysqli_fetch_assoc($query)) {?>
                            <div class="card">
                                <a href="Lap-trinh-ke-hoach-kinh-doanh-hieu-qua.html" class="motsanpham" style="text-decoration: none; color: black;" data-toggle="tooltip" data-placement="bottom" title="Xuân Quý">
